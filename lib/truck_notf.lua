...
local typeStyle = {
	...
	{ -- 4 - custom blue
	text = imgui.ImColor(255, 255, 255, 255):GetVec4(),
	rightBox = imgui.ImColor(123, 138, 211, 255):GetU32(),
	mainBox = {
		imgui.ImColor(103, 118, 191, 170):GetU32(), -- left top
		imgui.ImColor(103, 118, 191, 235):GetU32(), -- right top
		imgui.ImColor(103, 118, 191, 235):GetU32(), -- left button
		imgui.ImColor(103, 118, 191, 170):GetU32(), -- right button
	}
	},
	{ -- 5 - custom dark blue
	text = imgui.ImColor(255, 255, 255, 255):GetVec4(),
	rightBox = imgui.ImColor(70, 68, 90, 255):GetU32(),
	mainBox = {
		imgui.ImColor(50, 48, 70, 170):GetU32(), -- left top
		imgui.ImColor(50, 48, 70, 235):GetU32(), -- right top
		imgui.ImColor(50, 48, 70, 235):GetU32(), -- left button
		imgui.ImColor(50, 48, 70, 170):GetU32(), -- right button
	}
	}
}
local msxMsg = 3
...
function imgui.BeforeDrawFrame()
    ...
    if not fontChanged then
        ...
        imgui.GetIO().Fonts:AddFontFromFileTTF(getFolderPath(0x14) .. '\\trebucbd.ttf', y < 1080 and 14 or 15, nil, glyph_ranges)
		imgui.RebuildFonts()
    end
end
